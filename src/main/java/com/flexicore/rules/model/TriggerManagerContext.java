...
public class TriggerManagerContext {
    ...
    public <T extends TriggerManagerContext> T setScenarioTriggerEvent(ScenarioTriggerEvent<?> scenarioTriggerEvent) {
    ...
    public <T extends TriggerManagerContext> T setScenarioTrigger(ScenarioTrigger scenarioTrigger) {
