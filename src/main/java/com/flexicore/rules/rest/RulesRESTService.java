...
public class RulesRESTService implements RestServicePlugin {
	...
	public FlexiCoreRuleLink updateRuleLink(
			...
			@Context SecurityContext securityContext) {
		FlexiCoreRuleLink flexiCoreRuleLink = ruleLinkUpdate.getId() != null
				? service.getByIdOrNull(ruleLinkUpdate.getId(),
						FlexiCoreRuleLink.class, null, securityContext) : null;
		if (flexiCoreRuleLink == null) {
			throw new BadRequestException("No FlexiCoreRuleLink with id "
					+ ruleLinkUpdate.getId());
		}
	...
	public FlexiCoreRuleOp updateRuleOp(
			@HeaderParam("authenticationKey") String authenticationKey,
			RuleUpdateOp ruleUpdate, @Context SecurityContext securityContext) {
		FlexiCoreRuleOp flexiCoreRuleOp = ruleUpdate.getId() != null ? service
				.getByIdOrNull(ruleUpdate.getId(), FlexiCoreRuleOp.class, null,
	...
	public FlexiCoreRule updateRule(
			@HeaderParam("authenticationKey") String authenticationKey,
			RuleUpdate ruleUpdate, @Context SecurityContext securityContext) {
		FlexiCoreRule flexiCoreRule = ruleUpdate.getId() != null ? service
				.getByIdOrNull(ruleUpdate.getId(), FlexiCoreRule.class, null,
						securityContext) : null;
		if (flexiCoreRule == null) {
			throw new BadRequestException("No Rule with id "
					+ ruleUpdate.getId());
		}
