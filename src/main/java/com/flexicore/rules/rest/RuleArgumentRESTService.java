...
public class RuleArgumentRESTService implements RestServicePlugin {
	...
	// " an empty object {} or fully/partially filled filter")
	@POST
	...
	public FlexiCoreRuleArgument updateRuleArgument(
			...
			@Context SecurityContext securityContext) {
		FlexiCoreRuleArgument flexiCoreRuleArgument = ruleUpdate.getId() != null
				? service.getByIdOrNull(ruleUpdate.getId(),
