...
public class RulesService implements ServicePlugin {
    ...
    public Map<String, ExecuteInvokerRequest> evaluateActionManager(
        ...
        try {
            ...
            ActionManagerContext actionManagerContext = new ActionManagerContext(this,baseclassNewService)
    ...
    private EvaluateRuleResponse evaluateRuleNode(
		...
		Scenario scenario=evaluateRuleRequest.getScenario();
		String scenarioName=scenario!=null?scenario.getName():"unknown";
		String scenarioId=scenario!=null?scenario.getId():"unknown";
        try {
            ...
            scriptLogger = getLogger(evaluateRuleRequest.getScenario());
            ...
            logger.log(Level.SEVERE, "failed executing script , for scenario "+scenarioName+"("+scenarioId+")", e);
            scriptLogger.log(Level.SEVERE,
                    "failed executing script: " + e.toString(), e);
        } finally {
            flush(scriptLogger);
