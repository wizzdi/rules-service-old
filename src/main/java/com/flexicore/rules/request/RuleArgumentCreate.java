...
public class RuleArgumentCreate  {
    ...
    public <T extends RuleArgumentCreate> T setDynamicExecutionId(String dynamicExecutionId) {
    ...
    public <T extends RuleArgumentCreate> T setDynamicExecution(DynamicExecution dynamicExecution) {
